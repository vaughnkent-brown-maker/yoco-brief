...
<env:Envelope xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:env="http://schemas.xmlsoap.org/soap/envelope/">
  <env:Body>
    ...
    const [customData, prevTasksData, openTasksData, contactsData, oppsData, casesData] = await Promise.all([
      ...
      safeQuery(`SELECT Id, Name, StageName, Amount, CloseDate, Owner.Name, Description, Type, LeadSource, Probability, NextStep
    ...
    const rateKey = find(['transaction', 'rate']) || find(['card', 'rate']) || find(['mdr']) || find(['discount', 'rate']) || find(['fee', 'rate']) || find(['pricing', 'rate']);
    // Intercom keys
    ...
    return res.status(200).json({
      ...
      transactionRate: rateKey ? d[rateKey] : null,
